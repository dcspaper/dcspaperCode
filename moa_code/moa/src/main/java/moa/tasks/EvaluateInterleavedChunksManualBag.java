...
public class EvaluateInterleavedChunksManualBag extends ClassificationMainTask {
    ...
    public ClassOption learnerOption = new ClassOption("learner", 'l',
            "Classifier to train.", Learner.class, "moa.classifiers.meta.ManualBag");
...
//            Instances train_chunk = new Instances(stream.getHeader(), chunkSize);

            for (int i=0; i< chunkInstances.numInstances(); i++) {
//                train_chunk.add(chunkInstances.instance(i));
//                learner.trainOnInstance(new InstanceExample(chunkInstances.instance(i)));
                instancesProcessed++;
            }
            learner.trainChunk(chunkInstances, stream.getHeader());
