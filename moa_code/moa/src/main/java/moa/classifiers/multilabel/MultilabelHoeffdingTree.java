...
// Get votes from the classifier in the learning node of the tree
	...
	protected LearningNode newLearningNode(double[] initialClassObservations, int depth) {
		...
		return new MultilabelLearningNodeClassifier(initialClassObservations,null,this, depth);
	}

	//@Override
	protected LearningNode newLearningNode(double[] initialClassObservations, Classifier cl, int depth) {
		// Create new Learning Node
		return new MultilabelLearningNodeClassifier(initialClassObservations,cl,this, depth);
	}
	...
	public static class MultilabelInactiveLearningNode extends InactiveLearningNode {
		...
		public MultilabelInactiveLearningNode(double[] initialClassObservations, int depth) {
	...
	public class MultilabelLearningNodeClassifier extends LearningNodeClassifier {
		...
		public MultilabelLearningNodeClassifier(double[] initialClassObservations, Classifier cl, MultilabelHoeffdingTree ht, int depth) {
			super(initialClassObservations, depth);
	...
	protected void deactivateLearningNode(ActiveLearningNode toDeactivate,
		...
		Node newLeaf = new MultilabelInactiveLearningNode(toDeactivate
				.getObservedClassDistribution(), parent.depth + 1);
		if (parent == null) {
