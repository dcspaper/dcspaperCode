 ...
 /*   public MultiChoiceOption leafpredictionOption = new MultiChoiceOption(
    ...
    public static class AdaSplitNode extends SplitNode implements NewNode {
        ...
        public AdaSplitNode(InstanceConditionalTest splitTest,
            ...
            super(splitTest, classObservations, size, depth);
            this.classifierRandom = new Random(this.randomSeed);
        }
        
        public AdaSplitNode(InstanceConditionalTest splitTest,
                double[] classObservations, int depth) {
            super(splitTest, classObservations, depth);
            this.classifierRandom = new Random(this.randomSeed);
        }
        ...
        public void learnFromInstance(Instance inst, HoeffdingAdaptiveTree ht, SplitNode parent, int parentBranch) {
            ...
            if (this.ErrorChange == true) {//&& this.alternateTree == null) {
                ...
                this.alternateTree = ht.newLearningNode(this.depth + 1);
    ...
    public static class AdaLearningNode extends LearningNodeNBAdaptive implements NewNode {
        ...
        public AdaLearningNode(double[] initialClassObservations, int depth) {
    ...
    protected LearningNode newLearningNode(double[] initialClassObservations, int depth) {
        ...
        return new AdaLearningNode(initialClassObservations, depth);
    }

   @Override
    protected SplitNode newSplitNode(InstanceConditionalTest splitTest,
            double[] classObservations, int size, int depth) {
        return new AdaSplitNode(splitTest, classObservations, size, depth);
    }
   
    @Override
    protected SplitNode newSplitNode(InstanceConditionalTest splitTest,
            double[] classObservations, int depth) {
        return new AdaSplitNode(splitTest, classObservations, depth);
    }
