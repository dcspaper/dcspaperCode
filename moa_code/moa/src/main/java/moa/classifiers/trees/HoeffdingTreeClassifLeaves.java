...
public class HoeffdingTreeClassifLeaves extends HoeffdingTree {
    ...
    public class LearningNodeClassifier extends ActiveLearningNode {
        ...
        public LearningNodeClassifier(double[] initialClassObservations, int depth) {
            super(initialClassObservations, depth);
        }

        public LearningNodeClassifier(double[] initialClassObservations, Classifier cl, HoeffdingTreeClassifLeaves ht, int depth) {
            super(initialClassObservations, depth);
    ...
    protected LearningNode newLearningNode(double[] initialClassObservations, int depth) {
        return new LearningNodeClassifier(initialClassObservations, null, this, depth);
    }

    //@Override
    protected LearningNode newLearningNode(double[] initialClassObservations, Classifier cl, int depth) {
        return new LearningNodeClassifier(initialClassObservations, cl, this, depth);
    }
                ...
                if (splitDecision.splitTest == null) {
                    ...
                    for (int i = 0; i < splitDecision.numSplits(); i++) {
                        ...
                        Node newChild = newLearningNode(splitDecision.resultingClassDistributionFromSplit(i),
                                ((LearningNodeClassifier) node).getClassifier(), newSplit.depth + 1);
